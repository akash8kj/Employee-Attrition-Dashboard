...
│
├── Documentation/
│   └── Employee_Attrition_Documentation.pdf
│
├── PostgreSQL/
...
│
├── Presentation/
│   └── Employee-Attrition-Presentation.pptx
│
├── Python EDA/
...
- Low job satisfaction strongly contributes to employee turnover.
- Poor work-life balance is a major driver of attrition.
- Data-driven HR strategies can improve employee retention while reducing hiring costs and operational disruption.
